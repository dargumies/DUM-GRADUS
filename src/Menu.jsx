...
const menuCategories = [
  ...
  },
  {
    ...
    label: "Snacks",
    items: [
      { name: "Bruschetta with salmon",   desc: "Crispy bread, cream cheese, lightly salted salmon, capers", price: "2 400 ₸" },
      { name: "Beef tartare",    desc: "Marbled beef, quail egg, Dijon mustard", price: "3 800 ₸" },
      { name: "Cheese plate",        desc: "Choice of 4 types of cheese, grapes, walnuts, honey",        price: "4 200 ₸" },
      { name: "Grilled scallops",     desc: "Scallops, truffle oil, cauliflower puree", price: "5 600 ₸" },
      { name: "Meat platter",        desc: "Prosciutto, bresaola, jamon, mustard, gherkins",            price: "4 800 ₸" },
      { name: "Tiger prawns",     desc: "Grilled garlic oil, lemon, hot sauce",               price: "4 500 ₸" },
    ],
  },
  {
    id: "vip",
